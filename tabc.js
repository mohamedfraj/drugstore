window.onload= function() {
    ...
    increment5=()=>{
        ...
        document.getElementById("total6").innerHTML="dt"+prix5.toFixed()
        totalprice()
    }
    decrement5=()=>{
        if(prix5<=0) return
    ...
    increment6=()=>{
        ...
        document.getElementById("total7").innerHTML="dt"+prix6.toFixed()
        totalprice()
    }
    decrement6=()=>{
        if(prix6<=0) return
    ...
    increment8=()=>{
        ...
        document.getElementById("total9").innerHTML="dt"+prix8.toFixed()
        totalprice()
    }
    decrement8=()=>{
        if(prix8<=0) return
    ...
    totalprice=()=>{
       ...
       document.getElementById("tots").innerHTML=totalprice.toFixed(1) + " dt"
    }
}